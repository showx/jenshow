...
- 脚本源：`https://raw.githubusercontent.com/showx/jenshow/main`
...
```bash
curl -fsSL https://raw.githubusercontent.com/showx/jenshow/main/install.sh | bash -s -- init ./myproject
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/showx/jenshow/main/install.sh | bash -s -- configure
```
...
curl -fsSL https://raw.githubusercontent.com/showx/jenshow/main/install.sh | sudo bash -s -- setup
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/showx/jenshow/main/install.sh | bash -s -- deploy-scripts ./my-project
```
